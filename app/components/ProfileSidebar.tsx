...
export default function ProfileSidebar({ userId }: ProfileSidebarProps) {
  ...
  const menuItems = [
    ...
    {
      title: 'Мои записи',
      href: `/profile/${userId}/appointments`,
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      title: 'Мои рецепты',
      href: `/profile/${userId}/prescriptions`,
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    <div className="w-full bg-white rounded-lg shadow-sm">
      ...
      <div className="p-6 border-t">
        <Link
          href="/logout"
          className="flex items-center px-4 py-3 text-red-600 transition-colors rounded-md hover:bg-red-50"
        >
